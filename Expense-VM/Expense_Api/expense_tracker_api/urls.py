...
urlpatterns = [
    ...
    path('income-categories/', views.get_IncomeCategories, name='get_income_categories'),
    path('income-categories/create/', views.create_IncomeCategory, name='create_income_category'),
